...
public interface WikiwscontrollerApi {
  ...
  Call<Object> getChapterWikiUsingGET(
    @Path("chapterId") String chapterId, @Body SessionParams sessionParams
  );
  ...
  Call<Object> getChapterWiseSyllabusWikiUsingGET(
    @Path("syllabusId") String syllabusId, @Body SessionParams sessionParams
  );
  ...
  Call<ModelAndView> lessonWikiDetailsUsingGET(
    @Path("lessonId") String lessonId, @Body SessionParams sessionParams
  );
