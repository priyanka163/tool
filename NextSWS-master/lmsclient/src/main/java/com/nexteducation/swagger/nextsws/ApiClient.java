package com.nexteducation.swagger.nextsws;
...
import com.nexteducation.swagger.nextsws.auth.HttpBasicAuth;
import com.nexteducation.swagger.nextsws.auth.ApiKeyAuth;
import com.nexteducation.swagger.nextsws.auth.OAuth;
import com.nexteducation.swagger.nextsws.auth.OAuth.AccessTokenListener;
import com.nexteducation.swagger.nextsws.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "https://octopus.nexterp.in:80/NextLMS";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
