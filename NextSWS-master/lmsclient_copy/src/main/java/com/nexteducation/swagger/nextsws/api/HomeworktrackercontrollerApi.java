...
public interface HomeworktrackercontrollerApi {
  ...
  Call<ModelAndView> getLatestPublishedHomeworkWithResourceUsingGET(
    @Path("sectionId") Long sectionId, @Path("subjectId") Long subjectId, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<ModelAndView> getLectureBasedOnPublishedDateForSectionUsingGET(
    @Path("sectionId") Long sectionId, @Path("publishedOn") String publishedOn, @Path("isNext") Boolean isNext, @Path("subjectId") Long subjectId, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
