...
public class AssessmentModuleResponse   {
  ...
  public AssessmentModuleResponse assessmentId(Long assessmentId) {
  ...
  **/
  ...
  public AssessmentModuleResponse assessmentType(AssessmentTypeEnum assessmentType) {
  ...
  **/
  ...
  public AssessmentModuleResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssessmentModuleResponse assessmentModuleResponse = (AssessmentModuleResponse) o;
    return Objects.equals(this.assessmentId, assessmentModuleResponse.assessmentId) &&
        Objects.equals(this.assessmentType, assessmentModuleResponse.assessmentType) &&
        Objects.equals(this.name, assessmentModuleResponse.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assessmentId, assessmentType, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssessmentModuleResponse {\n");
