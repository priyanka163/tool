...
public interface PostcontrollerApi {
  ...
  Call<Object> createPostResponseUsingPOST(
    @Body PostResponseRequest request, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> createPostUsingPOST(
    @Body PostRequest postRequest, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> createUserCommentUsingPOST(
    @Body UserCommentRequest request, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> deletePostUsingGET(
    @Path("postId") String postId, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> getChapterPostUsingGET(
    @Path("chapterId") String chapterId, @Path("page") Integer page, @Path("limit") Integer limit, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> getChapterWiseSyllabusPostUsingGET(
    @Path("syllabusId") String syllabusId, @Path("page") Integer page, @Path("limit") Integer limit, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId
  );
  ...
  Call<Object> getUserPostUsingGET(
    @Path("userId") Long userId, @Query("branchId") Long branchId, @Query("academicSessionId") Long academicSessionId, @Query("userId") Long userId2
  );
