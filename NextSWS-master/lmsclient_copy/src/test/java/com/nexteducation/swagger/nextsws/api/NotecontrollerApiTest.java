...
public class NotecontrollerApiTest {
    ...
    public void addNoteFileUsingPOSTTest() {
        ...
        Long userId = null;
        // AssetResponse response = api.addNoteFileUsingPOST(file, branchId, academicSessionId, userId);
    ...
    public void addNoteUsingPOSTTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // NoteResponse response = api.addNoteUsingPOST(noteRequest, branchId, academicSessionId, userId);
    ...
    public void getSubjectPageUsingGETTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // ModelAndView response = api.getSubjectPageUsingGET(syllabusId, pageUuid, pageName, ifCustomSyllabus, subjectName, schoolSubjectName, branchId, academicSessionId, userId);
