...
public class WikiwscontrollerApiTest {
    ...
    public void getChapterWikiUsingGETTest() {
        ...
        Long userId = null;
        // Object response = api.getChapterWikiUsingGET(chapterId, branchId, academicSessionId, userId);
    ...
    public void getChapterWiseSyllabusWikiUsingGETTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // Object response = api.getChapterWiseSyllabusWikiUsingGET(syllabusId, branchId, academicSessionId, userId);
    ...
    public void getSyllabusWikiUsingGETTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // Object response = api.getSyllabusWikiUsingGET(syllabusId, branchId, academicSessionId, userId);
    ...
    public void lessonWikiDetailsUsingGETTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // ModelAndView response = api.lessonWikiDetailsUsingGET(lessonId, branchId, academicSessionId, userId);
