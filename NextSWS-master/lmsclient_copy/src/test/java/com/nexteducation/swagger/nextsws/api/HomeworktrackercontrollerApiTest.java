...
public class HomeworktrackercontrollerApiTest {
    ...
    public void getLatestPublishedHomeworkWithResourceUsingGETTest() {
        ...
        Long userId = null;
        // ModelAndView response = api.getLatestPublishedHomeworkWithResourceUsingGET(sectionId, subjectId, branchId, academicSessionId, userId);
    ...
    public void getLectureBasedOnPublishedDateForSectionUsingGETTest() {
        ...
        Long academicSessionId = null;
        Long userId = null;
        // ModelAndView response = api.getLectureBasedOnPublishedDateForSectionUsingGET(sectionId, publishedOn, isNext, subjectId, branchId, academicSessionId, userId);
